...
- [View Transitions](https://developer.chrome.com/docs/web-platform/view-transitions?hl=es-419): Esta documentación de Google Chrome proporciona información sobre cómo crear transiciones de vista fluidas y animadas en aplicaciones web utilizando APIs como `history.pushState()` y eventos de animación. Estas técnicas pueden mejorar la experiencia del usuario al navegar por una aplicación web al proporcionar transiciones suaves entre las vistas.
...
- [p5.js](https://p5js.org/es/): Biblioteca de JavaScript para programación creativa, especialmente en el contexto de arte visual y diseño.
- [ml5.js](https://learn.ml5js.org/#/): Biblioteca de JavaScript que simplifica el uso de modelos de aprendizaje automático preentrenados en el navegador.
- [TensorFlow.js](https://www.tensorflow.org/js?hl=es-419): Biblioteca de JavaScript para entrenar y desplegar modelos de aprendizaje automático en el navegador y en Node.js.
