---
title: 🌐 Personal Blog & Wiki Template
...
1. Ensure your environment (local development and deployment) provides the `RAINDROP_ACCESS_TOKEN` environment variable.
...
1. **Add metadata in `src/constants.ts`**:
...
1. **Add to site tree** (optional, for navigation):
